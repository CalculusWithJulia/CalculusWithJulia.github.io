...
A graphing calculator makes it very easy to produce a graph. Within `Julia`, the add-on `Gadfly` package makes it even easier.
...
### Other means to describe curves
...
- [Parametric curves in two dimensions](integrals/parameterized_curves.html)

- [Polar Coordinates](integrals/polar_coordinates.html) 

## Bibliography

- [Bibliography](bibloography.html)
