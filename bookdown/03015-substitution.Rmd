...
<div id="de317b9a-6f5d-4064-92e3-8a12a01a96c9" style="width:600px;height:400px;"></div>
<script>
PLOT = document.getElementById('de317b9a-6f5d-4064-92e3-8a12a01a96c9');
...
<form name="WeaveQuestion" data-id="dtmeP01r" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_dtmeP01r" value="1"><div class="markdown">$\int u \cos(x) du$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_dtmeP01r" value="2"><div class="markdown">$\int u (1 - u^2) du$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_dtmeP01r" value="3"><div class="markdown">$\int u du$
</div>
</label>
</div>
...
<div id="dtmeP01r_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_dtmeP01r']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#dtmeP01r_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#dtmeP01r_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="Cwquedq3" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_Cwquedq3" value="1"><div class="markdown">$u=\sec(x)$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Cwquedq3" value="2"><div class="markdown">$u=\tan(x)^4$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Cwquedq3" value="3"><div class="markdown">$u=\tan(x)$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Cwquedq3" value="4"><div class="markdown">$u=\sec(x)^2$
</div>
</label>
</div>
...
<div id="Cwquedq3_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_Cwquedq3']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#Cwquedq3_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#Cwquedq3_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="IvEejdM9" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_IvEejdM9" value="1"><div class="markdown">$u=\sqrt{x^2 - 1}$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_IvEejdM9" value="2"><div class="markdown">$u=x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_IvEejdM9" value="3"><div class="markdown">$u=x^2$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_IvEejdM9" value="4"><div class="markdown">$u=x^2 - 1$
</div>
</label>
</div>
...
<div id="IvEejdM9_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_IvEejdM9']").on("change", function() {
correct = this.value == 4;

if(correct) {
$("#IvEejdM9_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#IvEejdM9_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="e0JHwxho" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_e0JHwxho" value="1"><div class="markdown"><p>Yes</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_e0JHwxho" value="2"><div class="markdown"><p>No</p>
</div>
</label>
</div>
...
<div id="e0JHwxho_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_e0JHwxho']").on("change", function() {
correct = this.value == 2;

if(correct) {
$("#e0JHwxho_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#e0JHwxho_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="yRSr7rEQ" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_yRSr7rEQ" value="1"><div class="markdown"><p>Yes</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_yRSr7rEQ" value="2"><div class="markdown"><p>No</p>
</div>
</label>
</div>
...
<div id="yRSr7rEQ_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_yRSr7rEQ']").on("change", function() {
correct = this.value == 1;

if(correct) {
$("#yRSr7rEQ_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#yRSr7rEQ_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="uKP56Bu8" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_uKP56Bu8" value="1"><div class="markdown">$\int u^3/x du$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_uKP56Bu8" value="2"><div class="markdown">$\int u du$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_uKP56Bu8" value="3"><div class="markdown">$\int u^3 du$
</div>
</label>
</div>
...
<div id="uKP56Bu8_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_uKP56Bu8']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#uKP56Bu8_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#uKP56Bu8_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="EYgkzAmE" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_EYgkzAmE" value="1"><div class="markdown">$u=\sin(x)$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_EYgkzAmE" value="2"><div class="markdown">$u=\tan(x)$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_EYgkzAmE" value="3"><div class="markdown">$u=\cos(x)$
</div>
</label>
</div>
...
<div id="EYgkzAmE_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_EYgkzAmE']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#EYgkzAmE_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#EYgkzAmE_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="6BcWkE5I" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_6BcWkE5I" value="1"><div class="markdown">$a=1,~ b=1$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_6BcWkE5I" value="2"><div class="markdown">$a=0,~ b=1$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_6BcWkE5I" value="3"><div class="markdown">$a=0,~ b=0$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_6BcWkE5I" value="4"><div class="markdown">$a=1,~ b=0$
</div>
</label>
</div>
...
<div id="6BcWkE5I_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_6BcWkE5I']").on("change", function() {
correct = this.value == 2;

if(correct) {
$("#6BcWkE5I_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#6BcWkE5I_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="mpm61pBW" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_mpm61pBW" value="1"><div class="markdown">$\sin(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_mpm61pBW" value="2"><div class="markdown">$\tan(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_mpm61pBW" value="3"><div class="markdown">$u = 1 - x^2$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_mpm61pBW" value="4"><div class="markdown">$\sec(u) = x$
</div>
</label>
</div>
...
<div id="mpm61pBW_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_mpm61pBW']").on("change", function() {
correct = this.value == 1;

if(correct) {
$("#mpm61pBW_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#mpm61pBW_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="h8eb8eCF" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_h8eb8eCF" value="1"><div class="markdown">$\tan(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_h8eb8eCF" value="2"><div class="markdown">$\sin(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_h8eb8eCF" value="3"><div class="markdown">$\sec(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_h8eb8eCF" value="4"><div class="markdown">$u = 1 + x^2$
</div>
</label>
</div>
...
<div id="h8eb8eCF_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_h8eb8eCF']").on("change", function() {
correct = this.value == 4;

if(correct) {
$("#h8eb8eCF_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#h8eb8eCF_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="i2Vrch6c" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_i2Vrch6c" value="1"><div class="markdown">$\sin(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_i2Vrch6c" value="2"><div class="markdown">$\sec(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_i2Vrch6c" value="3"><div class="markdown">$\tan(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_i2Vrch6c" value="4"><div class="markdown">$u = 1 - x^2$
</div>
</label>
</div>
...
<div id="i2Vrch6c_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_i2Vrch6c']").on("change", function() {
correct = this.value == 1;

if(correct) {
$("#i2Vrch6c_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#i2Vrch6c_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="PXAe1nZl" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_PXAe1nZl" value="1"><div class="markdown">$\sin(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_PXAe1nZl" value="2"><div class="markdown">$4\sec(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_PXAe1nZl" value="3"><div class="markdown">$4\sin(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_PXAe1nZl" value="4"><div class="markdown">$\sec(u) = x$
</div>
</label>
</div>
...
<div id="PXAe1nZl_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_PXAe1nZl']").on("change", function() {
correct = this.value == 2;

if(correct) {
$("#PXAe1nZl_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#PXAe1nZl_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="3aFlX1aa" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_3aFlX1aa" value="1"><div class="markdown">$\tan(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_3aFlX1aa" value="2"><div class="markdown">$a\sec(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_3aFlX1aa" value="3"><div class="markdown">$\tan(u) = x$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_3aFlX1aa" value="4"><div class="markdown">$\sec(u) = x$
</div>
</label>
</div>
...
<div id="3aFlX1aa_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_3aFlX1aa']").on("change", function() {
correct = this.value == 1;

if(correct) {
$("#3aFlX1aa_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#3aFlX1aa_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="5ib0yCGJ" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_5ib0yCGJ" value="1"><div class="markdown">$a=\pi/4,~ b=\pi/2$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_5ib0yCGJ" value="2"><div class="markdown">$a=1/2,~ b= 1$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_5ib0yCGJ" value="3"><div class="markdown">$a=\pi/3,~ b=\pi/2$
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_5ib0yCGJ" value="4"><div class="markdown">$a=\pi/6,~ b=\pi/2$
</div>
</label>
</div>
...
<div id="5ib0yCGJ_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_5ib0yCGJ']").on("change", function() {
correct = this.value == 4;

if(correct) {
$("#5ib0yCGJ_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#5ib0yCGJ_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="INFhFaDc" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_INFhFaDc" value="1"><div class="markdown"><p>We could differentiate $\log\lvert (sec(u) + tan(u))\rvert$ </p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_INFhFaDc" value="2"><div class="markdown"><p>We could differentiate $\sec(u)$.</p>
</div>
</label>
</div>
...
<div id="INFhFaDc_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_INFhFaDc']").on("change", function() {
correct = this.value == 1;

if(correct) {
$("#INFhFaDc_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#INFhFaDc_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
