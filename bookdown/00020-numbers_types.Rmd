...
We can define $a^0$ to be $1$, except for the special case of $0^0$, which is left undefined mathematically (though it is also defined as `1` within `Julia`).
...
As you can see, even with these familiar operations, the desire for simple things, such as the natural numbers and closure, leads one naturally into the need for more complicated systems such as the rational numberss, the real numbers or the complex numbers.
...
<div class="alert alert-info" role="alert">
<div class="markdown"><p>The basic operations in <code>Julia</code> are engineered to give the same <em>type</em> of output given the same <em>type(s)</em> of input. This is for performance reasons. This is the concept of <em>type stability</em>.</p>
</div> 
</div>
...
Rational numbers in `Julia` are stored as two numbers, one for the denominator and one for the numerator, each some type of integer. They can exactly represent a rational number. Unlike with floating point values, this leads to the familiar things being true:
...
<tr><td><div class="markdown"><p>Nullable{String}("construction")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}("<code>1</code>")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}("<code>1//1</code>")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}("<code>1.0</code>")</p>
</div></td></tr>
<tr><td><div class="markdown"><p>Nullable{String}("exact")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(true)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(true)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}("not usually")</p>
</div></td></tr>
<tr><td><div class="markdown"><p>Nullable{String}("wide range")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(false)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(false)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(true)</p>
</div></td></tr>
<tr><td><div class="markdown"><p>Nullable{String}("has infinity")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(false)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(false)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(true)</p>
</div></td></tr>
<tr><td><div class="markdown"><p>Nullable{String}("has <code>-0</code>")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(false)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(false)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(true)</p>
</div></td></tr>
<tr><td><div class="markdown"><p>Nullable{String}("fast")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(true)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(false)</p>
</div></td><td><div class="markdown"><p>Nullable{Any}(true)</p>
</div></td></tr>
<tr><td><div class="markdown"><p>Nullable{String}("closed under")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}("<code>&#43;</code>, <code>-</code>, <code>*</code>")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}("<code>&#43;</code>, <code>-</code>, <code>*</code>,<br/> <code>/</code> (non zero denominator),<br/><code>^</code> (integer power)")</p>
</div></td><td><div class="markdown"><p>Nullable{Any}("<code>&#43;</code>, <code>-</code>, <code>*</code>,<br/> <code>/</code> (possibly <code>NaN</code>, <code>Inf</code>),<br/><code>^</code> (non-negative base)")</p>
</div></td></tr>
...
<form name="WeaveQuestion" data-id="RafR1dM4" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_RafR1dM4" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_RafR1dM4" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_RafR1dM4" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_RafR1dM4" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_RafR1dM4" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="RafR1dM4_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_RafR1dM4']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#RafR1dM4_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#RafR1dM4_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="ZKdvU3Bo" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_ZKdvU3Bo" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_ZKdvU3Bo" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_ZKdvU3Bo" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_ZKdvU3Bo" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_ZKdvU3Bo" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="ZKdvU3Bo_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_ZKdvU3Bo']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#ZKdvU3Bo_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#ZKdvU3Bo_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="rkZ6nnJT" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_rkZ6nnJT" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_rkZ6nnJT" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_rkZ6nnJT" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_rkZ6nnJT" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_rkZ6nnJT" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="rkZ6nnJT_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_rkZ6nnJT']").on("change", function() {
correct = this.value == 2;

if(correct) {
$("#rkZ6nnJT_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#rkZ6nnJT_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="3qp2xCOf" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_3qp2xCOf" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_3qp2xCOf" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_3qp2xCOf" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_3qp2xCOf" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_3qp2xCOf" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="3qp2xCOf_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_3qp2xCOf']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#3qp2xCOf_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#3qp2xCOf_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="57lrPPH7" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_57lrPPH7" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_57lrPPH7" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_57lrPPH7" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_57lrPPH7" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_57lrPPH7" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="57lrPPH7_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_57lrPPH7']").on("change", function() {
correct = this.value == 1;

if(correct) {
$("#57lrPPH7_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#57lrPPH7_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="qMIus1d3" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_qMIus1d3" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_qMIus1d3" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_qMIus1d3" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_qMIus1d3" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_qMIus1d3" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="qMIus1d3_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_qMIus1d3']").on("change", function() {
correct = this.value == 4;

if(correct) {
$("#qMIus1d3_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#qMIus1d3_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="lO2nOKCf" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_lO2nOKCf" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_lO2nOKCf" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_lO2nOKCf" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_lO2nOKCf" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_lO2nOKCf" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="lO2nOKCf_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_lO2nOKCf']").on("change", function() {
correct = this.value == 5;

if(correct) {
$("#lO2nOKCf_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#lO2nOKCf_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="Twp3PmpQ" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_Twp3PmpQ" value="1"><div class="markdown"><p>Integer</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Twp3PmpQ" value="2"><div class="markdown"><p>Rational</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Twp3PmpQ" value="3"><div class="markdown"><p>FloatingPoint</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Twp3PmpQ" value="4"><div class="markdown"><p>Complex</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Twp3PmpQ" value="5"><div class="markdown"><p>None, an error occurs</p>
</div>
</label>
</div>
...
<div id="Twp3PmpQ_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_Twp3PmpQ']").on("change", function() {
correct = this.value == 3;

if(correct) {
$("#Twp3PmpQ_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#Twp3PmpQ_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="KzM4Z9GB" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_KzM4Z9GB" value="1"><div class="markdown"><p>Yes</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_KzM4Z9GB" value="2"><div class="markdown"><p>No</p>
</div>
</label>
</div>
...
<div id="KzM4Z9GB_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_KzM4Z9GB']").on("change", function() {
correct = this.value == 1;

if(correct) {
$("#KzM4Z9GB_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#KzM4Z9GB_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
...
<form name="WeaveQuestion" data-id="Nk1cpn6A" data-controltype="radio">
<div class="form-group ">

<div  class="radio"> 
<label>
<input type="radio" name="radio_Nk1cpn6A" value="1"><div class="markdown"><p>Yes</p>
</div>
</label>
</div>
...
<div  class="radio"> 
<label>
<input type="radio" name="radio_Nk1cpn6A" value="2"><div class="markdown"><p>No</p>
</div>
</label>
</div>
...
<div id="Nk1cpn6A_message"></div>
</div>
</form>
<script text="text/javascript">
$("input:radio[name='radio_Nk1cpn6A']").on("change", function() {
correct = this.value == 2;

if(correct) {
$("#Nk1cpn6A_message").html("<div class='alert alert-success'><span class='glyphicon glyphicon-thumbs-up'>&nbsp;Correct</span></div>");
} else {
$("#Nk1cpn6A_message").html("<div class='alert alert-warning'><span class='glyphicon glyphicon-thumbs-down'>&nbsp;Incorrect</span></div>");
}
});
